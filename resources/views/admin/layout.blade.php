...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{url('ui_newspaper/img/favicon.png')}}">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="{{url('admin/dashboard')}}" class="logo"><img style="width: 150px; height: auto" src="{{url('newspepa_cms/img/logo.png')}}"></a>
            <!--logo end-->
